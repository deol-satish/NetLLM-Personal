...
class OfflineRLPolicy(nn.Module):
    def __init__(
        ...
        self.modules_except_plm = nn.ModuleList([  # used to save and load modules except plm
            ...
            self.embed_state6, self.embed_state7, self.emed_state8, self.action_head
        ])
    ...
    def forward(self, states, actions, returns, timesteps, attention_mask=None):
        ...
        states_embeddings7 = self.embed_state6(states_features[5]) + time_embeddings
        states_embeddings8 = self.embed_state6(states_features[5]) + time_embeddings
    ...
    def sample(self, state, target_return, timestep, **kwargs):
        ...
        state_embeddings7 = self.embed_state6(state_features[5]) + time_embeddings
        state_embeddings8 = self.embed_state6(state_features[5]) + time_embeddings
